...
public class Car extends  Vehicle {
    ...
    public Car(String name, int passengers){
        super(passengers);
        try {
    ...
    /**
     *  To string method
     * @return the vehicle name and passengers
     */

    @Override
    public String toString() {
        return "Car: " +  vehicleName + " have " + super.vehiclePassengers + " Passengers";
    }
    ...
    public int embarkCost(){
        embarkCost = 0;
        embarkCost = 100 + 20 * numberOfPassengers;
